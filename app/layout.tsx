...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: 'https://kkado-kkado.com/icon-48.png', sizes: '48x48', type: 'image/png' },
      { url: 'https://kkado-kkado.com/icon-192.png', sizes: '192x192', type: 'image/png' },
      { url: 'https://kkado-kkado.com/icon-512.png', sizes: '512x512', type: 'image/png' },
      { url: 'https://kkado-kkado.com/icon-32.png', sizes: '32x32', type: 'image/png' },
    ],
    shortcut: 'https://kkado-kkado.com/favicon.ico',
    apple: [
      { url: 'https://kkado-kkado.com/apple-touch-icon.png', sizes: '180x180', type: 'image/png' },
    ],
  },
  openGraph: {
