...
2. 구조 제약:
   - 질문(questions) 개수는 **반드시 정확히 6개**여야 합니다. (Vercel의 10초 실행 시간 제한 내에 안전하게 생성하기 위해 6개로 고정합니다).
   ...
   - 질문 수가 6개이므로, 사용자가 얻을 수 있는 총점은 최소 6점 ~ 최대 24점입니다.
     결과 구간(minScore, maxScore)을 다음과 같이 수학적 오차 없이 정확히 분할해 주세요:
     - 6~10점 / 11~15점 / 16~20점 / 21~24점
